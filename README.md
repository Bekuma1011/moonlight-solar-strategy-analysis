Here is a cleaned, well-structured version of your `README.md` section with consistent formatting, accurate descriptions, and a fixed heading. This version is suitable for your `scripts/README.md`:
